...
public class Ventana extends JFrame {
    ...
    public Ventana() {
        ...
        JLabel title_login = new JLabel("INICIAR SESION", SwingConstants.CENTER);
        ...
        ask.setBounds(200, 275, 150, 20);
        ask.setFont(new Font("Segoe UI", Font.PLAIN, 11));
        ask.setForeground(new Color(0, 102, 204));
        ...
        acceder.setBackground(new Color(52, 152, 219));
        ...
        JComboBox<String> colonia = new JComboBox<>(colonias);
