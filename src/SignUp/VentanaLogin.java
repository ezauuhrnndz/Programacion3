...
public class VentanaLogin extends JFrame {
	...
	public void alta() {	
        ...
        ImageIcon LogoDos = new ImageIcon("Moodle-logo.svg.png");

        JLabel textoLogoDos = new JLabel("", SwingConstants.CENTER);
        textoLogoDos.setIcon(LogoDos);
        textoLogoDos.setBounds(0, 0, 400, 480);
        textoLogoDos.setFont(new Font("Segoe UI", Font.BOLD, 16));
        contenedorLogo.add(textoLogoDos);
	...
	public void baja() {
        ...
        // Confirmacion extra para evitar bajas accidentales
	...
	public void consultar() {
        ...
        // Radio buttons para elegir el criterio de busqueda
        ...
        // Area de texto para mostrar el resultado de la consulta (solo lectura)
	...
	public void crearUser() {
        ...
        // Boton directo para ir al modulo de alta
        final Color colorNaranjaOriginal = Color.decode("#DE6A00");
        final Color colorNaranjaHover = Color.decode("#FF8C00");
	...
	public void olvidoContra() {
	    ...
	    // Panel derecho con el formulario de recuperacion de contra
	    JPanel contenedor = new JPanel();
	    contenedor.setBounds(550, 40, 400, 480);
	    contenedor.setBackground(Color.white);
	    contenedor.setLayout(null);
	...
	public void recuperarCuenta() {
        ...
        // Panel derecho con el formulario para restablecer contra
        JPanel contenedor = new JPanel();
        contenedor.setBounds(550, 40, 400, 480);
        contenedor.setBackground(Color.white);
        contenedor.setLayout(null);
        ...
        // Campo para confirmar la nueva contra
        ...
        // Boton para guardar la nueva contra
        ...
        // Validacion de que las contrasenas coincidan antes de guardar
