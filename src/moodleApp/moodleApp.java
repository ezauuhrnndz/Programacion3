...
public class moodleApp extends JFrame {
	...
	public void alta() {
		...
		JLabel descripcionAlta = new JLabel(
				"<html><center>Completa el formulario<br>para dar de alta<br>un nuevo usuario</center></html>",
		...
		btnAlta.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				btnAlta.setBackground(colorNaranjaHover);
			}
		...
		btnAlta.addActionListener(e -> {
			if (txtNombre.getText().isEmpty() || txtEmail.getText().isEmpty()) {
				...
				JOptionPane.showMessageDialog(this, "Usuario dado de alta exitosamente.", "Alta exitosa",
	...
	public void baja() {
		...
		JLabel descripcionBaja = new JLabel(
				"<html><center>Esta accion eliminara<br>al usuario del sistema.<br><br>Procede con cuidado.</center></html>",
				SwingConstants.CENTER);
		...
		String[] motivos = { "Selecciona un motivo", "Solicitud del usuario", "Inactividad prolongada",
				"Violacion de terminos", "Otro" };
		...
		btnBaja.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBaja.setBackground(colorRojoHover);
			}
		...
		btnBaja.addActionListener(e -> {
			if (txtUsuarioBaja.getText().isEmpty()) {
				JOptionPane.showMessageDialog(this, "Ingresa el usuario o email a dar de baja.", "Campo vacio",
						JOptionPane.WARNING_MESSAGE);
			} else if (!chkConfirmar.isSelected()) {
				JOptionPane.showMessageDialog(this, "Debes confirmar la accion antes de continuar.",
						"Confirmacion requerida", JOptionPane.WARNING_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(this, "Usuario dado de baja correctamente.", "Baja exitosa",
						JOptionPane.INFORMATION_MESSAGE);
			}
		});
	...
	public void consultar() {
		...
		JLabel descripcionConsulta = new JLabel(
				"<html><center>Busca un usuario por<br>nombre, email o ID<br>para ver su informacion</center></html>",
				SwingConstants.CENTER);
		...
		txtBuscar.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(200, 200, 200)),
				BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		...
		btnBuscar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnBuscar.setBackground(colorNaranjaHover);
			}
		...
		btnBuscar.addActionListener(e -> {
			if (txtBuscar.getText().isEmpty()) {
				JOptionPane.showMessageDialog(this, "Ingresa un termino de busqueda.", "Campo vacio",
						JOptionPane.WARNING_MESSAGE);
			} else {
				areaResultado
						.setText("Nombre: Juan Perez\nEmail: juan@ejemplo.com\nRol: Administrador\nEstado: Activo");
			}
		});
	...
	public void crearUser() {
		...
		JLabel descripcionCrear = new JLabel(
				"<html><center>Aprende a crear<br>un nuevo usuario<br>paso a paso</center></html>",
				SwingConstants.CENTER);
		...
		btnIrAlta.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnIrAlta.setBackground(colorNaranjaHover);
			}
	...
	public void accederSistema() {
		...
		JLabel descripcionAcceder = new JLabel(
				"<html><center>Sigue estos pasos<br>para iniciar sesion<br>en el sistema</center></html>",
				SwingConstants.CENTER);
		...
		JLabel consejo = new JLabel(
				"<html><i>Tip: si olvidaste tu contrasena,<br>usa la opcion de recuperacion.</i></html>");
		...
		btnIrLogin.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnIrLogin.setBackground(colorNaranjaHover);
			}
	...
	public void olvidoContra() {
		...
		// Texto informativo dentro del panel izquierdo
		JLabel descripcionOlvido = new JLabel(
				"<html><center>Te enviaremos un enlace<br>para que puedas<br>restablecer tu contrasena</center></html>",
				SwingConstants.CENTER);
		...
		JLabel instruccion = new JLabel(
				"<html>Ingresa tu email y te enviaremos<br>las instrucciones para recuperarla.</html>");
		...
		btnEnviar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnEnviar.setBackground(colorNaranjaHover);
			}
		...
		btnEnviar.addActionListener(e -> {
			if (txtEmailOlvido.getText().isEmpty()) {
				JOptionPane.showMessageDialog(this, "Ingresa tu email para continuar.", "Campo vacio",
						JOptionPane.WARNING_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(this, "Enlace enviado a: " + txtEmailOlvido.getText(), "Correo enviado",
						JOptionPane.INFORMATION_MESSAGE);
	...
	public void recuperarCuenta() {
		...
		JLabel descripcionRecuperar = new JLabel(
				"<html><center>Crea una nueva contraseña<br>segura para proteger<br>tu cuenta</center></html>",
				SwingConstants.CENTER);
		...
		txtCodigo.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(200, 200, 200)),
				BorderFactory.createEmptyBorder(0, 10, 0, 0)));
		...
		btnGuardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnGuardar.setBackground(colorNaranjaHover);
			}
		...
		btnGuardar.addActionListener(e -> {
			...
			if (txtCodigo.getText().isEmpty() || nuevaPass.isEmpty()) {
				...
				JOptionPane.showMessageDialog(this, "Las contrasenas no coinciden.", "Error",
						JOptionPane.ERROR_MESSAGE);
				txtConfirmarPass.setBorder(BorderFactory.createLineBorder(Color.red, 3, true));
			} else {
				JOptionPane.showMessageDialog(this, "Contrasena actualizada correctamente.", "Exito",
						JOptionPane.INFORMATION_MESSAGE);
				this.router("login");
			}
		});
